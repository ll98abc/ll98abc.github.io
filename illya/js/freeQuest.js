function initFreeQuestData(){
	...
	freeQuestList[0] = {			
			...
			enemy: "狂薑餅人(7k)*3/狂薑餅人(8k)*2+不是♂少女德翁子(19k)",
			drop: "布丁",
			locate: "a_4" ,
	...
	freeQuestList[1] = {
			...
			enemy: "弓骨兵(5k)*3/弓骨兵(8k)*2+貓耳☆少女阿塔喵(26k)",
			drop: "DVD",
			locate: "a_2",
	...
	freeQuestList[2] = {
			...
			cost: "15",
			prev: "對魔法☆少女童謠醬造成100k傷害 (擊倒3次)",
			enemy: "殺人馬(5k)*3/殺人馬(8k)*2+婚紗☆少女芙蘭肯(25k)",
			drop: "獅子君",
			locate: "a_4",
	...
	freeQuestList[4] = {			
			...
			enemy: "弓龍牙兵(8k)*2+殺幽靈(8k)/弓龍牙兵(9k)*2+殺幽靈(9k)/殺幽靈(11k)+間諜☆少女瑪塔子(53k)",
			drop: "布丁+DVD",
			locate: "b_3",
	...
	freeQuestList[6] = {
			...
			cost: "20",
			prev: "對治癒☆少女C子蘿造成200k傷害(擊倒2次)",
			enemy: "殺幽靈(9k)*2+槍飛龍(9k)/殺幽靈(10k)*2+殺幽靈(11k)/槍飛龍(15k)*2+魔法☆御姊美杜莎(43k)",
			drop: "DVD+獅子君",
			locate: "b_2",
	...
	freeQuestList[8] = {			
			...
			cost: "20",
			prev: "unknown",
			enemy: "殺女鬼(?)*3/殺女鬼(?)*3/殺女鬼(?)*2+猛毒☆少女靜謐炭(?)",
			drop: "DVD",
			locate: "c_1",
