function initFreeQuestData(){
	...
	wantedQuestList[0] = {			
			name: "【高難易度】罪と罰 ～散華すべきは白い髭～",
			cost: "0",
			prev: "全Mission完成",
			enemy: "100隻機械龍娘(30k上下七職都有)+芙蘭爸爸(164K弓) *全體龍娘攻擊力UP(永續buff)/(218K弓) *break後全體龍娘爆擊傷害提升(永續buff)+自身防禦力提升(3T)/(246K弓) *break後全體龍娘爆擊率提升(永續buff)+自身防禦力提升(3T)/擊倒芙蘭爸爸即可通關", 
			drop: "弓金棋",
			locate: "factory",
			tag: "--"
	}
